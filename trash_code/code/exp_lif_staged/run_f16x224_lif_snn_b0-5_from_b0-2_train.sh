...
export SNN_BLOCK_INDICES="${SNN_BLOCK_INDICES:-0,1,2,3,4,5}"
...
PREV_OUTPUT_DIR="${PREV_OUTPUT_DIR:-${PROJECT_DIR}/outputs/videomamba_small_lif_unsigned_snn_b0-1-2_t${SNN_TIMESTEPS}_from_ann}"
...
export JOB_NAME="${JOB_NAME:-videomamba_small_lif_${SNN_SIGN_TAG}_snn_b${SNN_BLOCK_TAG}_t${SNN_TIMESTEPS}_from_b0-2}"
...
echo "Training higher-scope VideoMamba LIF SNN from b0-2"
