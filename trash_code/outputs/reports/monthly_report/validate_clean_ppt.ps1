...
$source = "D:\code\PYTHON\video_sm\outputs\monthly_report\monthly_report_2026_05_clean.pptx"
$outDir = "D:\code\PYTHON\video_sm\outputs\monthly_report\clean_preview"
