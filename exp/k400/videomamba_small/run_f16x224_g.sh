...
JOB_NAME='(4.9)_baseline)_et_g_2view12_0.3'
#3证据量融合，固定位置,插入前后帧左右下角,1/3大小,双应用
...
--kill-on-bad-exit=1 \
python /HOME/scw6fgn/run/VideoMamba-main/videomamba/video_sm/run_class_finetuning_g.py \
