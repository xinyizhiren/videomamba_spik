...
#JOB_NAME='(5.24)_01_3_2311)'
#JOB_NAME='(5.24)_023_4_2311)'
#JOB_NAME='(5.24)_023_5_2311)'
#JOB_NAME='(5.24)_01_1.5_2311)'

#JOB_NAME='(5.25)_base_tt_5)'
#JOB_NAME='(5.25)_base_1'
#JOB_NAME='(5.26)_edl_1'
JOB_NAME='(6.9)_2311'
...
srun -p $PARTITION \
        ...
        --kill-on-bad-exit=1 \
        python /HOME/scw6fgn/run/VideoMamba-main/videomamba/video_sm/run_class_finetuning_mst_1.py \
