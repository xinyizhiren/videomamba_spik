...
#JOB_NAME='(5.24)_2_0_2311)'

# k=3（互访双图）,80%，对比，5ce2,6帧互放，大小1/4，尽量不重叠，0，20,40,60,80,100叠加,nucla
...
#JOB_NAME='(5.24)_video'

# 空间,k=2,60%融合
#JOB_NAME='(5.24)_023_4_2311)'
#JOB_NAME='(5.24)_02_3_2311)'
#JOB_NAME='(5.24)_02_4_2311)'
#JOB_NAME='(5.24)_02_5_2311)'

#JOB_NAME='(5.25)_base_tt_4)'
#JOB_NAME='(5.26)_base_tt_1'

#edl
#JOB_NAME='(5.26)_edl_0.5'
#JOB_NAME='(5.28)_base_4'
...
srun -p $PARTITION \
        ...
        --kill-on-bad-exit=1 \
        python /HOME/scw6fgn/run/VideoMamba-main/videomamba/video_sm/run_class_finetuning_mst.py \
