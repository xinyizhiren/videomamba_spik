...
SNN_PRE_BLOCK_INDICES="${SNN_PRE_BLOCK_INDICES:-}"
SNN_POST_BLOCK_INDICES="${SNN_POST_BLOCK_INDICES:-}"
...
if [ -n "${SNN_PRE_BLOCK_INDICES}" ]; then
        CMD+=(--snn_pre_block_indices "${SNN_PRE_BLOCK_INDICES}")
fi

if [ -n "${SNN_POST_BLOCK_INDICES}" ]; then
        CMD+=(--snn_post_block_indices "${SNN_POST_BLOCK_INDICES}")
fi
