...
_MODELS = {
    ...
    # "videomamba_s16_in1k": os.path.join(MODEL_PATH, "checkpoint_best.pth"),
    # "videomamba_s16_in1k": os.path.join(MODEL_PATH, "r3d_18-b3b3357e.pth"),
...
class Block(nn.Module):
    def __init__(
            self, dim, mixer_cls, norm_cls=nn.LayerNorm, bimamba = False, fused_add_norm=False, residual_in_fp32=False, drop_path=0.,
    ):
        """
